...
export const CATEGORIES: Record<string, Category> = {
  ...
  luxury: {
    ...
    color: "#1F2430",
    blurb: "Le haut de gamme de la sécurité résidentielle : finitions premium, marques reconnues, matériel certifié pour la télésurveillance professionnelle.",
  },
};

export const CATEGORY_ORDER = ["perimeter", "detection", "response", "resilience", "family", "guides", "luxury"] as const;
...
export const ARTICLES: ArticleMeta[] = [
  ...
  {
    slug: "livres-cybersecurite",
    category: "guides",
    kind: "comparison",
    kicker: "Sélection",
    title: "5 livres pour comprendre la cybersécurité",
    excerpt:
      "Protéger sa maison, c'est aussi protéger ses données : voici 5 livres pour comprendre les menaces numériques et apprendre à s'en protéger, du débutant à l'expert.",
    standfirst:
      "Du guide accessible pour débutant à l'ouvrage de référence sur l'analyse des malwares, cinq livres pour monter en compétence sur la cybersécurité, de 8 € à 50 €.",
    meta: "5 livres sélectionnés",
    date: "11 sept.",
    number: 415,
    readingTime: "5 min de lecture",
    updated: "Mis à jour le 11 septembre 2026",
    image: "/images/products/livre-cybersecurite-protegez-vie-numerique.jpg",
    imageAlt: "Livre sur la cybersécurité posé sur un bureau",
    facts: [
      { value: "5", label: "livres sélectionnés" },
      { value: "8 € — 50 €", label: "fourchette de prix" },
      { value: "Débutant à expert", label: "niveaux couverts" },
    ],
    blocks: [
      {
        k: "p",
        text: "La sécurité de la maison ne s'arrête pas à la porte d'entrée : mots de passe, réseau Wi-Fi, objets connectés, tout ça se protège aussi. Cette sélection va du guide accessible pour un premier niveau à des ouvrages plus techniques pour approfondir.",
      },
      { k: "h2", text: "Notre sélection" },
      {
        k: "pick",
        rank: "01",
        name: "Cybersécurité : Protégez Votre Vie Numérique, Guide Débutant à Expert",
        price: "7,95 €",
        badge: "Meilleure note",
        tone: "good",
        verdict: "Note parfaite et accessible même sans bagage technique — le meilleur point de départ.",
        pros: ["Meilleure note, 5 étoiles", "Accessible même sans bagage technique"],
        cons: ["Format numérique uniquement"],
        href: "https://www.amazon.fr/dp/B0GSMYQPF7?tag=secure012de-21",
        image: "/images/products/livre-cybersecurite-protegez-vie-numerique.jpg",
        imageAlt: "Cybersécurité : Protégez Votre Vie Numérique",
      },
      {
        k: "pick",
        rank: "02",
        name: "Cybersécurité Nouvelle Génération, Défendre Contre les Attaques Intelligentes",
        price: "24,98 €",
        badge: "Le plus actuel",
        tone: "good",
        verdict: "Aborde spécifiquement les menaces liées à l'intelligence artificielle, un sujet très actuel.",
        pros: ["Aborde les menaces liées à l'IA, très actuel", "Bien noté, 4,2 étoiles"],
        cons: ["Plus technique que le guide débutant"],
        href: "https://www.amazon.fr/dp/B0F5M9MYTB?tag=secure012de-21",
        image: "/images/products/livre-cybersecurite-nouvelle-generation.jpg",
        imageAlt: "Cybersécurité Nouvelle Génération",
      },
      {
        k: "pick",
        rank: "03",
        name: "Cybersécurité, Sécurité Informatique et Réseaux, 5e édition",
        price: "30,99 €",
        badge: "Référence académique",
        tone: "good",
        verdict: "Un classique académique désormais dans sa 5e édition, très bien noté.",
        pros: ["Référence académique, 5e édition", "Très bien noté, 4,4 étoiles"],
        cons: ["Plus dense, orienté formation"],
        href: "https://www.amazon.fr/dp/B01M330IBT?tag=secure012de-21",
        image: "/images/products/livre-cybersecurite-securite-informatique-reseaux.jpg",
        imageAlt: "Cybersécurité, Sécurité Informatique et Réseaux",
      },
      {
        k: "pick",
        rank: "04",
        name: "Cybersécurité, Principes Fondamentaux",
        price: "49,99 €",
        badge: "Ouvrage collectif",
        tone: "ok",
        verdict: "Un ouvrage collectif signé par plusieurs experts, dense mais complet.",
        pros: ["Ouvrage collectif signé par plusieurs experts", "Bien noté, 4,4 étoiles"],
        cons: ["Le plus dense des cinq"],
        href: "https://www.amazon.fr/dp/B09F5QQ1NX?tag=secure012de-21",
        image: "/images/products/livre-cybersecurite-principes-fondamentaux.jpg",
        imageAlt: "Cybersécurité, Principes Fondamentaux",
      },
      {
        k: "pick",
        rank: "05",
        name: "Cybersécurité et Malwares, Détection, Analyse et Threat Intelligence",
        price: "44,50 €",
        badge: "Le plus avancé",
        tone: "good",
        verdict: "Note parfaite pour cet ouvrage à jour sur l'analyse des malwares, destiné à un public déjà initié.",
        pros: ["Note parfaite, 5 étoiles", "4e édition, très à jour sur les malwares actuels"],
        cons: ["Le plus avancé, pour un public déjà initié"],
        href: "https://www.amazon.fr/dp/2409038107?tag=secure012de-21",
        image: "/images/products/livre-cybersecurite-malwares-threat-intelligence.jpg",
        imageAlt: "Cybersécurité et Malwares",
      },
      { k: "h2", text: "Comment on choisit" },
      { k: "method", items: METHOD_ITEMS },
    ],
  ...
  {
    slug: "cameras-solaires-exterieures",
    category: "detection",
    kind: "comparison",
    kicker: "Comparatif",
    title: "Les 5 meilleures caméras de surveillance solaires extérieures",
    excerpt:
      "Sans câble d'alimentation ni prise à proximité, la caméra solaire s'installe n'importe où dans le jardin : voici 5 modèles qui tiennent la promesse, du premier prix au kit multi-caméras.",
    standfirst:
      "Du modèle d'entrée de gamme à 40 € au kit 4K avec station de base, cinq caméras solaires qui n'ont besoin ni de prise ni de box internet à proximité.",
    meta: "5 produits comparés",
    date: "12 sept.",
    number: 416,
    readingTime: "6 min de lecture",
    updated: "Mis à jour le 12 septembre 2026",
    image: "/images/products/aosu-t2-ultra-kit-2-cameras-4k.jpg",
    imageAlt: "Caméra de surveillance solaire installée en extérieur",
    facts: [
      { value: "5", label: "caméras comparées" },
      { value: "40 € — 320 €", label: "fourchette de prix" },
      { value: "100%", label: "sans câble d'alimentation" },
    ],
    blocks: [
      {
        k: "p",
        text: "La caméra solaire résout le principal problème de la vidéosurveillance extérieure : trouver une prise électrique près de l'endroit à surveiller. Avec un panneau solaire intégré ou séparé, elle se pose au fond du jardin, sur un portail ou une façade exposée sans tirer le moindre câble. Le WiFi reste la norme, mais certains modèles vont plus loin avec une connexion 4G pour se passer aussi de box internet.",
      },
      { k: "h2", text: "Notre sélection" },
      {
        k: "pick",
        rank: "01",
        name: "Cinnado Caméra Solaire 2K WiFi Extérieure IP65",
        price: "39,99 €",
        badge: "Premier prix",
        tone: "ok",
        verdict: "Le prix d'entrée pour découvrir la caméra solaire, avec vision nocturne couleur et audio bidirectionnel.",
        pros: ["Le moins cher du comparatif", "Vision nocturne couleur et audio bidirectionnel"],
        cons: ["Résolution 2K seulement, pas de 4K"],
        href: "https://www.amazon.fr/dp/B0GXVNM9K2?tag=secure012de-21",
        image: "/images/products/cinnado-camera-solaire-2k-ip65.jpg",
        imageAlt: "Cinnado Caméra Solaire 2K WiFi Extérieure IP65",
      },
      {
        k: "pick",
        rank: "02",
        name: "COOAU Caméra Solaire 2K WiFi 360°",
        price: "48,99 €",
        badge: "Rotation 360°",
        tone: "good",
        verdict: "La rotation à 360° couvre tout le jardin depuis un seul point d'installation, avec Wi-Fi 6.",
        pros: ["Rotation à 360° pour couvrir tout le jardin", "Wi-Fi 6 et alarme anti-intrusion intégrée"],
        cons: ["Panneau solaire à orienter soi-même pour une charge optimale"],
        href: "https://www.amazon.fr/dp/B0F1MT6QBY?tag=secure012de-21",
        image: "/images/products/cooau-camera-solaire-2k-360-ptz.jpg",
        imageAlt: "COOAU Caméra Solaire 2K WiFi 360°",
      },
      {
        k: "pick",
        rank: "03",
        name: "ieGeek Caméra Solaire 2K WiFi 360°",
        price: "49,88 €",
        badge: "Détection IA",
        tone: "good",
        verdict: "La détection humaine par intelligence artificielle limite les fausses alertes déclenchées par un animal ou une branche.",
        pros: ["Détection humaine par intelligence artificielle, moins de fausses alertes", "Compatible Alexa"],
        cons: ["Marque moins connue que les grands noms de la vidéosurveillance"],
        href: "https://www.amazon.fr/dp/B0CNCRQW9F?tag=secure012de-21",
        image: "/images/products/iegeek-camera-solaire-2k-ia.jpg",
        imageAlt: "ieGeek Caméra Solaire 2K WiFi 360°",
      },
      {
        k: "pick",
        rank: "04",
        name: "Vosker VKX Caméra 4G Solaire sans WiFi",
        price: "249,90 €",
        badge: "Sans WiFi ni box",
        tone: "good",
        verdict: "Une carte SIM incluse remplace le WiFi : idéale pour un terrain isolé, un chalet ou une résidence secondaire.",
        pros: ["Fonctionne sans box internet ni WiFi grâce à la carte SIM incluse", "Idéale pour un terrain isolé ou une résidence secondaire"],
        cons: ["Abonnement data à prévoir après l'essai inclus"],
        href: "https://www.amazon.fr/dp/B0FDXKV6CN?tag=secure012de-21",
        image: "/images/products/vosker-vkx-camera-4g-solaire.jpg",
        imageAlt: "Vosker VKX Caméra 4G Solaire sans WiFi",
      },
      {
        k: "pick",
        rank: "05",
        name: "aosu T2 Ultra Kit 2 Caméras 4K Solaires 360°",
        price: "319,99 €",
        badge: "Kit 2 caméras 4K",
        tone: "good",
        verdict: "Un kit complet de 2 caméras 4K avec station de base, suivi automatique et détection humain/véhicule/animal.",
        pros: ["Kit de 2 caméras 4K livré avec une station de base", "Suivi automatique et détection humain, véhicule ou animal"],
        cons: ["Le plus cher du comparatif"],
        href: "https://www.amazon.fr/dp/B0GCD435G3?tag=secure012de-21",
        image: "/images/products/aosu-t2-ultra-kit-2-cameras-4k.jpg",
        imageAlt: "aosu T2 Ultra Kit 2 Caméras 4K Solaires 360°",
      },
      { k: "h2", text: "Comment on choisit" },
      { k: "method", items: METHOD_ITEMS },
    ],
  ...
  {
    slug: "capteurs-ouverture-porte-fenetre-connectes",
    category: "perimeter",
    kind: "comparison",
    kicker: "Comparatif",
    title: "Les 5 meilleurs capteurs d'ouverture connectés pour porte et fenêtre",
    excerpt:
      "Un petit aimant, une notification sur le téléphone dès qu'une porte ou une fenêtre s'ouvre : voici 5 capteurs connectés, du WiFi autonome au Zigbee le plus répandu, pour surveiller les accès sans grand chantier.",
    standfirst:
      "Du capteur WiFi à 12 € au modèle Matter sur Thread dernier cri, cinq façons de savoir en temps réel quand une porte ou une fenêtre s'ouvre chez vous.",
    meta: "5 produits comparés",
    date: "12 sept.",
    number: 417,
    readingTime: "6 min de lecture",
    updated: "Mis à jour le 12 septembre 2026",
    image: "/images/products/aqara-detecteur-ouverture-zigbee.jpg",
    imageAlt: "Capteur d'ouverture connecté posé sur le cadre d'une fenêtre",
    facts: [
      { value: "5", label: "capteurs comparés" },
      { value: "12 € — 33 €", label: "fourchette de prix" },
      { value: "WiFi, Zigbee, Matter", label: "protocoles couverts" },
    ],
    blocks: [
      {
        k: "p",
        text: "Le capteur d'ouverture reste l'un des moyens les plus simples de savoir ce qui se passe chez soi : un aimant sur la porte ou la fenêtre, un petit boîtier collé au cadre, et une notification instantanée dès que les deux s'écartent. Deux familles cohabitent sur le marché : le WiFi, qui se connecte directement à la box sans matériel supplémentaire, et le Zigbee ou Matter, plus économe en pile mais qui nécessite un hub domotique.",
      },
      { k: "h2", text: "Notre sélection" },
      {
        k: "pick",
        rank: "01",
        name: "Tapo T110 Détecteur Ouverture Porte Fenêtre",
        price: "12,31 €",
        badge: "Meilleur prix",
        tone: "good",
        verdict: "La marque TP-Link, très bien notée, avec plus d'un an d'autonomie annoncée sur une seule pile.",
        pros: ["Marque TP-Link, très bien noté par les clients", "Autonomie de plus d'un an annoncée sur une seule pile"],
        cons: ["Nécessite un hub Tapo pour recevoir les alertes à distance"],
        href: "https://www.amazon.fr/dp/B0BF5MC9QX?tag=secure012de-21",
        image: "/images/products/tapo-t110-detecteur-ouverture-porte.jpg",
        imageAlt: "Tapo T110 Détecteur Ouverture Porte Fenêtre",
      },
      {
        k: "pick",
        rank: "02",
        name: "Sone Détecteur Connecté Ouverture Porte WiFi",
        price: "12,99 €",
        badge: "WiFi sans hub",
        tone: "ok",
        verdict: "Se connecte en WiFi direct à la box, sans hub supplémentaire à acheter.",
        pros: ["Fonctionne en WiFi direct, sans hub à acheter en plus", "Prix proche du moins cher du comparatif"],
        cons: ["Portée WiFi à tester selon l'épaisseur des murs"],
        href: "https://www.amazon.fr/dp/B0CQ56T4M4?tag=secure012de-21",
        image: "/images/products/sone-detecteur-ouverture-porte-wifi.jpg",
        imageAlt: "Sone Détecteur Connecté Ouverture Porte WiFi",
      },
      {
        k: "pick",
        rank: "03",
        name: "Aqara Détecteur Ouverture Porte Fenêtre Zigbee",
        price: "19,99 €",
        badge: "Référence Zigbee",
        tone: "good",
        verdict: "Le détecteur Zigbee le plus répandu de ce type, compatible avec la plupart des hubs domotiques.",
        pros: ["Détecteur Zigbee le plus répandu de ce type sur le marché", "Compatible avec la plupart des hubs domotiques"],
        cons: ["Nécessite un hub Aqara, vendu séparément"],
        href: "https://www.amazon.fr/dp/B07D37VDM3?tag=secure012de-21",
        image: "/images/products/aqara-detecteur-ouverture-zigbee.jpg",
        imageAlt: "Aqara Détecteur Ouverture Porte Fenêtre Zigbee",
      },
      {
        k: "pick",
        rank: "04",
        name: "SONOFF Détecteur Fenêtre Zigbee Lot de 4",
        price: "30,30 €",
        badge: "Lot de 4",
        tone: "good",
        verdict: "Un lot de 4 capteurs économique pour équiper plusieurs fenêtres d'un coup, avec alarme de sabotage.",
        pros: ["Lot de 4 capteurs, économique pour équiper plusieurs fenêtres", "Alarme de sabotage en cas de démontage du capteur"],
        cons: ["Nécessite un hub Zigbee compatible"],
        href: "https://www.amazon.fr/dp/B0GKFB66JZ?tag=secure012de-21",
        image: "/images/products/sonoff-senseguard-detecteur-fenetre-lot4.jpg",
        imageAlt: "SONOFF Détecteur Fenêtre Zigbee Lot de 4",
      },
      {
        k: "pick",
        rank: "05",
        name: "Aqara Détecteur Ouverture P2 Matter sur Thread",
        price: "32,99 €",
        badge: "Matter sur Thread",
        tone: "good",
        verdict: "Le standard domotique le plus récent, avec des automatisations locales qui ne dépendent pas d'un serveur distant.",
        pros: ["Matter sur Thread, le standard domotique le plus récent", "Automatisations locales, sans dépendre d'un serveur distant"],
        cons: ["Le plus cher du comparatif, nécessite un routeur de bordure Thread"],
        href: "https://www.amazon.fr/dp/B0BTL8B72D?tag=secure012de-21",
        image: "/images/products/aqara-detecteur-ouverture-p2-matter.jpg",
        imageAlt: "Aqara Détecteur Ouverture P2 Matter sur Thread",
      },
      { k: "h2", text: "Comment on choisit" },
      { k: "method", items: METHOD_ITEMS },
    ],
  ...
  {
    slug: "sirenes-alarme-exterieures-connectees",
    category: "response",
    kind: "comparison",
    kicker: "Comparatif",
    title: "Les 5 meilleures sirènes d'alarme extérieures connectées",
    excerpt:
      "Une sirène extérieure bien visible dissuade souvent mieux qu'un simple capteur discret : voici 5 sirènes connectées, du modèle WiFi autonome au matériel professionnel utilisé par les installateurs.",
    standfirst:
      "Du boîtier WiFi à 40 € au matériel professionnel Ajax à plus de 200 €, cinq sirènes extérieures pour faire fuir un intrus avant qu'il n'entre.",
    meta: "5 produits comparés",
    date: "12 sept.",
    number: 418,
    readingTime: "6 min de lecture",
    updated: "Mis à jour le 12 septembre 2026",
    image: "/images/products/ajax-street-siren-double-deck.jpg",
    imageAlt: "Sirène d'alarme extérieure fixée sur une façade",
    facts: [
      { value: "5", label: "sirènes comparées" },
      { value: "40 € — 232 €", label: "fourchette de prix" },
      { value: "120 dB+", label: "volume des modèles testés" },
    ],
    blocks: [
      {
        k: "p",
        text: "Une alarme qui se contente d'envoyer une notification discrète n'arrête pas grand-chose sur le moment : c'est la sirène extérieure, visible et bruyante, qui fait fuir un cambrioleur avant qu'il n'ait le temps d'agir. La plupart de ces sirènes fonctionnent en complément d'un système d'alarme existant plutôt qu'en autonome, ce qui explique pourquoi presque toutes sont liées à un écosystème précis.",
      },
      { k: "h2", text: "Notre sélection" },
      {
        k: "pick",
        rank: "01",
        name: "Sirène Extérieure WiFi Tuya 120 dB",
        price: "39,99 €",
        badge: "Premier prix",
        tone: "ok",
        verdict: "Le prix d'entrée pour une sirène connectée, avec batterie rechargeable intégrée.",
        pros: ["Le moins cher du comparatif", "Batterie rechargeable intégrée, fonctionne aussi en coupure de courant"],
        cons: ["Compatible uniquement avec des capteurs 433 MHz existants"],
        href: "https://www.amazon.fr/dp/B0FP9G1FGP?tag=secure012de-21",
        image: "/images/products/sirene-exterieure-wifi-tuya-pst.jpg",
        imageAlt: "Sirène Extérieure WiFi Tuya 120 dB",
      },
      {
        k: "pick",
        rank: "02",
        name: "VIGIO Sirène Alarme Extérieure Solaire Connectée",
        price: "59,00 €",
        badge: "Solaire",
        tone: "ok",
        verdict: "Alimentation solaire, aucun câblage nécessaire, mais liée au système d'alarme VIGIO.",
        pros: ["Alimentation solaire, aucun câblage nécessaire", "Se déclenche automatiquement avec le système d'alarme associé"],
        cons: ["Fonctionne uniquement avec le système d'alarme VIGIO"],
        href: "https://www.amazon.fr/dp/B0HCNSMYBL?tag=secure012de-21",
        image: "/images/products/vigio-sirene-exterieure-solaire.jpg",
        imageAlt: "VIGIO Sirène Alarme Extérieure Solaire Connectée",
      },
      {
        k: "pick",
        rank: "03",
        name: "tiiwee A3 Sirène d'Extérieur",
        price: "79,90 €",
        badge: "Écosystème alarme",
        tone: "good",
        verdict: "Une marque spécialisée dans les systèmes d'alarme sans abonnement, bien notée par les clients.",
        pros: ["Marque spécialisée dans les systèmes d'alarme sans abonnement", "Bien notée, avec un bon volume d'avis clients"],
        cons: ["Fonctionne uniquement avec l'écosystème d'alarme tiiwee"],
        href: "https://www.amazon.fr/dp/B07GXX89V3?tag=secure012de-21",
        image: "/images/products/tiiwee-a3-sirene-exterieure.jpg",
        imageAlt: "tiiwee A3 Sirène d'Extérieur",
      },
      {
        k: "pick",
        rank: "04",
        name: "Sirène Extérieure 120 dB Batterie de Secours",
        price: "79,99 €",
        badge: "Meilleure note",
        tone: "good",
        verdict: "La meilleure note du comparatif, avec une batterie de secours 5000 mAh résistante aux intempéries.",
        pros: ["Meilleure note du comparatif", "Batterie de secours 5000 mAh, résistante aux intempéries"],
        cons: ["Pas de panneau solaire, batterie à recharger manuellement"],
        href: "https://www.amazon.fr/dp/B0GRW7B4H9?tag=secure012de-21",
        image: "/images/products/huxgo-sirene-exterieure-batterie-secours.jpg",
        imageAlt: "Sirène Extérieure 120 dB Batterie de Secours",
      },
      {
        k: "pick",
        rank: "05",
        name: "Ajax Sirène Extérieure Deux Niveaux",
        price: "231,97 €",
        badge: "Matériel professionnel",
        tone: "good",
        verdict: "Le matériel utilisé par les installateurs d'alarme professionnels, avec flash lumineux et sirène combinés.",
        pros: ["Marque professionnelle utilisée par les installateurs d'alarme", "Flash lumineux et sirène combinés, très résistante"],
        cons: ["Le plus cher du comparatif, nécessite l'écosystème Ajax"],
        href: "https://www.amazon.fr/dp/B08M5QGR2S?tag=secure012de-21",
        image: "/images/products/ajax-street-siren-double-deck.jpg",
        imageAlt: "Ajax Sirène Extérieure Deux Niveaux",
      },
      { k: "h2", text: "Comment on choisit" },
      { k: "method", items: METHOD_ITEMS },
    ],
  ...
  {
    slug: "securite-maison-luxe",
    category: "luxury",
    kind: "comparison",
    kicker: "Comparatif",
    title: "Les 5 meilleurs produits de sécurité haut de gamme pour une maison de luxe",
    excerpt:
      "Une maison de luxe attire plus de convoitises et mérite du matériel à la hauteur : voici 5 produits de sécurité premium, du coffre-fort double paroi à la centrale d'alarme certifiée utilisée par les installateurs professionnels.",
    standfirst:
      "Du visiophone 2K à la centrale d'alarme certifiée EN 50131, cinq produits de sécurité premium pour une maison qui a plus à protéger que la moyenne.",
    meta: "5 produits comparés",
    date: "12 sept.",
    number: 419,
    readingTime: "6 min de lecture",
    updated: "Mis à jour le 12 septembre 2026",
    image: "/images/products/lifebox-coffre-fort-double-parois-40l.jpg",
    imageAlt: "Coffre-fort haut de gamme dans une maison de luxe",
    facts: [
      { value: "5", label: "produits comparés" },
      { value: "236 € — 515 €", label: "fourchette de prix" },
      { value: "EN 50131", label: "certification pro sur la centrale d'alarme" },
    ],
    blocks: [
      {
        k: "p",
        text: "Une maison de luxe a plus de valeur à protéger, et souvent plus de surface à couvrir : le matériel d'entrée de gamme montre vite ses limites. Ce comparatif réunit cinq produits positionnés sur le haut du marché, choisis pour leurs finitions (aluminium plutôt que plastique), leurs certifications professionnelles ou leur robustesse, avec un budget nettement supérieur à nos comparatifs habituels.",
      },
      { k: "h2", text: "Notre sélection" },
      {
        k: "pick",
        rank: "01",
        name: "Netatmo Caméra Extérieure Intelligente avec Sirène 105 dB",
        price: "235,99 €",
        badge: "Design aluminium",
        tone: "ok",
        verdict: "Un boîtier aluminium soigné plutôt qu'un dôme en plastique, avec sirène et éclairage intégrés, sans abonnement.",
        pros: ["Boîtier aluminium au design soigné, sans abonnement requis", "Sirène 105 dB et éclairage intégrés pour dissuader à distance"],
        cons: ["Nécessite une bonne portée WiFi jusqu'à l'extérieur de la maison"],
        href: "https://www.amazon.fr/dp/B0B8DW39TZ?tag=secure012de-21",
        image: "/images/products/netatmo-camera-exterieure-sirene-105db.jpg",
        imageAlt: "Netatmo Caméra Extérieure Intelligente avec Sirène 105 dB",
      },
      {
        k: "pick",
        rank: "02",
        name: "EZVIZ CP7 Interphone Vidéo 2K WiFi",
        price: "259,99 €",
        badge: "Image 2K",
        tone: "good",
        verdict: "Une image 2K nettement plus nette que les visiophones classiques en 1080p, avec WiFi bi-bande pour une connexion stable.",
        pros: ["Image 2K, nettement plus détaillée qu'un visiophone classique en 1080p", "WiFi bi-bande 2,4/5 GHz pour une connexion plus stable"],
        cons: ["Installation filaire à 2 fils, moins simple qu'un modèle tout sans-fil"],
        href: "https://www.amazon.fr/dp/B0CLV9ZG9M?tag=secure012de-21",
        image: "/images/products/ezviz-cp7-visiophone.jpg",
        imageAlt: "EZVIZ CP7 Interphone Vidéo 2K WiFi",
      },
      {
        k: "pick",
        rank: "03",
        name: "tedee GO2 Alu Serrure Biométrique Classe 6",
        price: "269,20 €",
        badge: "Certifiée Classe 6",
        tone: "good",
        verdict: "Carter aluminium et lecteur d'empreinte Keypad PRO, avec la certification de résistance la plus élevée de la gamme tedee.",
        pros: ["Carter aluminium et clavier à empreinte digitale Keypad PRO inclus", "Certifiée Classe 6, le niveau de résistance le plus élevé de la gamme"],
        cons: ["Le bridge WiFi pour le contrôle à distance se vend séparément"],
        href: "https://www.amazon.fr/dp/B0GNN1T453?tag=secure012de-21",
        image: "/images/products/tedee-go2-serrure-biometrique-alu.jpg",
        imageAlt: "tedee GO2 Alu Serrure Biométrique Classe 6",
      },
      {
        k: "pick",
        rank: "04",
        name: "Lifebox Coffre-Fort Double Parois 40L",
        price: "499,00 €",
        badge: "Double paroi",
        tone: "good",
        verdict: "Une double paroi et une heure de résistance au feu, la meilleure protection incendie de ce comparatif, chez le leader français du secteur.",
        pros: ["Double paroi et ignifuge 1h, la meilleure protection incendie du comparatif", "LIFEBOX, marque française leader de la sécurité domestique"],
        cons: ["30 kg à vide, prévoir un scellement au mur ou au sol"],
        href: "https://www.amazon.fr/dp/B00ITRSOCM?tag=secure012de-21",
        image: "/images/products/lifebox-coffre-fort-double-parois-40l.jpg",
        imageAlt: "Lifebox Coffre-Fort Double Parois 40L",
      },
      {
        k: "pick",
        rank: "05",
        name: "Ajax Hub 2 Plus Centrale d'Alarme Professionnelle 4G",
        price: "514,78 €",
        badge: "Certifiée EN 50131",
        tone: "good",
        verdict: "La centrale utilisée par les installateurs professionnels, certifiée pour la télésurveillance et doublement connectée en 4G et Ethernet.",
        pros: ["Certifiée EN 50131 Degré 2, le niveau utilisé par les installateurs professionnels", "Double SIM 4G et Ethernet : reste connectée même si la ligne est coupée"],
        cons: ["Centrale seule : détecteurs et sirènes s'achètent séparément"],
        href: "https://www.amazon.fr/dp/B0GFDDX3JX?tag=secure012de-21",
        image: "/images/products/ajax-hub-2-plus-alarme-professionnelle.jpg",
        imageAlt: "Ajax Hub 2 Plus Centrale d'Alarme Professionnelle 4G",
      },
      { k: "h2", text: "Comment on choisit" },
      { k: "method", items: METHOD_ITEMS },
    ],
  ...
  {
    slug: "judas-numeriques-porte",
    category: "detection",
    kind: "comparison",
    kicker: "Comparatif",
    title: "Les 5 meilleurs judas numériques pour porte d'entrée",
    excerpt:
      "Voir qui sonne sans coller l'œil à la porte, et même depuis son téléphone : voici 5 judas numériques qui remplacent l'ancien judas optique, du modèle à écran simple au judas 4K connecté.",
    standfirst:
      "Du judas électronique Yale à 45 € au modèle EZVIZ 4K à écran tactile, cinq judas numériques qui s'installent dans le trou du judas existant, sans perçage ni câble.",
    meta: "5 produits comparés",
    date: "16 sept.",
    number: 420,
    readingTime: "6 min de lecture",
    updated: "Mis à jour le 16 septembre 2026",
    image: "/images/products/ezviz-ep4-judas-4k-ecran-tactile.jpg",
    imageAlt: "Judas numérique avec écran installé sur une porte d'entrée",
    facts: [
      { value: "5", label: "judas comparés" },
      { value: "45 € — 200 €", label: "fourchette de prix" },
      { value: "3", label: "consultables à distance en WiFi" },
    ],
    blocks: [
      {
        k: "p",
        text: "Le judas numérique remplace l'œilleton optique classique par une petite caméra côté palier et un écran côté intérieur. Plus besoin de coller l'œil à la porte : l'image s'affiche d'un geste, lisible par toute la famille, y compris les enfants et les personnes âgées. La pose se fait dans le trou du judas existant, sans perçage ni câble. Les modèles connectés vont plus loin et envoient l'image sur le téléphone, pour voir qui est devant la porte même quand on n'est pas à la maison.",
      },
      { k: "h2", text: "Notre sélection" },
      {
        k: "pick",
        rank: "01",
        name: "Yale Judas Électronique Numérique 105°",
        price: "44,99 €",
        badge: "Premier prix",
        tone: "ok",
        verdict: "Le judas électronique le plus simple : un bouton, un écran, et on voit qui est à la porte sans se pencher.",
        pros: ["Remplace directement le judas mécanique existant", "Le moins cher du comparatif, d'une marque reconnue de la serrurerie"],
        cons: ["Pas de WiFi : l'image ne se consulte que devant la porte"],
        href: "https://www.amazon.fr/dp/B014LC93QO?tag=secure012de-21",
        image: "/images/products/yale-judas-electronique-numerique-blanc.jpg",
        imageAlt: "Yale Judas Électronique Numérique 105°",
      },
      {
        k: "pick",
        rank: "02",
        name: "EZVIZ CP2 Judas sans Fil Écran 4,3 Pouces",
        price: "69,99 €",
        badge: "Connecté WiFi",
        tone: "good",
        verdict: "Un grand écran couleur à l'intérieur et la vue en direct sur le téléphone via le WiFi, sur batterie rechargeable.",
        pros: ["Vue en direct depuis le téléphone grâce au WiFi", "Grand écran couleur de 4,3 pouces, facile à lire"],
        cons: ["Pas de détection de mouvement"],
        href: "https://www.amazon.fr/dp/B0D92GJRFX?tag=secure012de-21",
        image: "/images/products/ezviz-cp2-judas-sans-fil-ecran-4-3.jpg",
        imageAlt: "EZVIZ CP2 Judas sans Fil Écran 4,3 Pouces",
      },
      {
        k: "pick",
        rank: "03",
        name: "Imou VD1 Judas Numérique 3K avec Écran 4,3 Pouces",
        price: "79,99 €",
        badge: "Détection humaine",
        tone: "good",
        verdict: "Une image 3K plus détaillée, un angle de 149° et la détection humaine pour être alerté quand quelqu'un s'approche.",
        pros: ["Image 3K et vision à 149° pour couvrir tout le palier", "Détection humaine et grosse batterie de 4800 mAh"],
        cons: ["Pas de vision nocturne selon le fabricant"],
        href: "https://www.amazon.fr/dp/B0G6CYZTVG?tag=secure012de-21",
        image: "/images/products/imou-vd1-judas-numerique-3k.jpg",
        imageAlt: "Imou VD1 Judas Numérique 3K avec Écran 4,3 Pouces",
      },
      {
        k: "pick",
        rank: "04",
        name: "DoorCAM DC2 PLUS Judas Numérique Écran 4,3 Pouces",
        price: "119,90 €",
        badge: "Portes épaisses",
        tone: "ok",
        verdict: "Pensé pour la simplicité : un bouton, une image en moins d'une seconde, et une compatibilité avec les portes jusqu'à 110 mm d'épaisseur.",
        pros: ["Un seul bouton, aucune application requise", "Compatible avec les portes épaisses, jusqu'à 110 mm"],
        cons: ["Fonctionne avec 4 piles AAA non incluses, sans accès à distance"],
        href: "https://www.amazon.fr/dp/B07DW9ZYFL?tag=secure012de-21",
        image: "/images/products/doorcam-dc2-plus-judas-numerique.jpg",
        imageAlt: "DoorCAM DC2 PLUS Judas Numérique Écran 4,3 Pouces",
      },
      {
        k: "pick",
        rank: "05",
        name: "EZVIZ EP4 Judas 4K Écran Tactile 5,5 Pouces",
        price: "199,99 €",
        badge: "Image 4K",
        tone: "good",
        verdict: "Le judas haut de gamme : image 4K, grand écran tactile, reconnaissance faciale et audio bidirectionnel.",
        pros: ["Image 4K et reconnaissance faciale intégrée", "Écran tactile de 5,5 pouces et angle ultra-large de 155°"],
        cons: ["Le plus cher du comparatif"],
        href: "https://www.amazon.fr/dp/B0G5113DT4?tag=secure012de-21",
        image: "/images/products/ezviz-ep4-judas-4k-ecran-tactile.jpg",
        imageAlt: "EZVIZ EP4 Judas 4K Écran Tactile 5,5 Pouces",
      },
      { k: "h2", text: "Comment on choisit" },
      { k: "method", items: METHOD_ITEMS },
    ],
  ...
  {
    slug: "antivols-velo-u",
    category: "perimeter",
    kind: "comparison",
    kicker: "Comparatif",
    title: "Les 5 meilleurs antivols vélo en U haute sécurité",
    excerpt:
      "Le vol de vélo se joue souvent en quelques secondes avec une pince coupante : voici 5 antivols en U en acier trempé, du premier prix à l'antivol classé Sold Secure Diamond.",
    standfirst:
      "De l'antivol Yale à 16 € au Seatylock classé Sold Secure Diamond et à l'ABUS Granit, cinq antivols en U pour garer son vélo dehors plus sereinement.",
    meta: "5 produits comparés",
    date: "16 sept.",
    number: 421,
    readingTime: "6 min de lecture",
    updated: "Mis à jour le 16 septembre 2026",
    image: "/images/products/abus-granit-xplus-540-antivol-u.jpg",
    imageAlt: "Antivol en U attaché à un vélo",
    facts: [
      { value: "5", label: "antivols comparés" },
      { value: "16 € — 100 €", label: "fourchette de prix" },
      { value: "3", label: "livrés avec un support ou un câble" },
    ],
    blocks: [
      {
        k: "p",
        text: "Un simple câble se coupe en quelques secondes avec une pince. L'antivol en U, avec son arceau en acier trempé, résiste bien mieux et oblige le voleur à sortir un outil lourd et bruyant. Tout se joue sur l'épaisseur de l'arceau, la qualité du cylindre et le mécanisme de verrouillage. Pensez aussi au support de cadre, qui évite de porter l'antivol dans un sac, et à un câble complémentaire pour attacher la roue avant.",
      },
      { k: "h2", text: "Notre sélection" },
      {
        k: "pick",
        rank: "01",
        name: "Yale Antivol en U Vélo Acier Trempé avec Support",
        price: "15,79 €",
        badge: "Premier prix",
        tone: "ok",
        verdict: "Un arceau de 18 mm en acier trempé et un support de cadre, pour moins de 16 € : le minimum pour un usage quotidien.",
        pros: ["Acier trempé résistant à la coupe", "Le moins cher du comparatif, avec anse de 18 mm et support inclus"],
        cons: ["Niveau de protection pensé pour un usage quotidien, pas pour une nuit dehors"],
        href: "https://www.amazon.fr/dp/B0D76TF1GH?tag=secure012de-21",
        image: "/images/products/yale-antivol-u-velo-yul0-18.jpg",
        imageAlt: "Yale Antivol en U Vélo Acier Trempé avec Support",
      },
      {
        k: "pick",
        rank: "02",
        name: "Zéfal K-Traz U17 Antivol en U Haute Résistance",
        price: "36,99 €",
        badge: "Quadruple verrouillage",
        tone: "good",
        verdict: "Un arceau massif et un quadruple système de verrouillage qui résiste à la traction et à la torsion.",
        pros: ["Quadruple verrouillage contre traction et torsion", "Arceau massif en acier de 14 mm"],
        cons: ["Câble de 120 cm proposé en option selon la version"],
        href: "https://www.amazon.fr/dp/B0778VBSD6?tag=secure012de-21",
        image: "/images/products/zefal-k-traz-u17-antivol-u.jpg",
        imageAlt: "Zéfal K-Traz U17 Antivol en U Haute Résistance",
      },
      {
        k: "pick",
        rank: "03",
        name: "Kryptonite Evolution Mini-7 Antivol en U avec Câble",
        price: "43,99 €",
        badge: "Meilleure note",
        tone: "good",
        verdict: "Le best-seller de la marque de référence : un U compact niveau 7/10 livré avec un câble double boucle pour la roue.",
        pros: ["Câble inclus pour la roue avant", "Plus de 14 000 avis clients sur Amazon.fr"],
        cons: ["Format mini : moins facile à passer autour d'un gros poteau"],
        href: "https://www.amazon.fr/dp/B06XZT8KZ1?tag=secure012de-21",
        image: "/images/products/kryptonite-evolution-mini-7-flex.jpg",
        imageAlt: "Kryptonite Evolution Mini-7 Antivol en U avec Câble",
      },
      {
        k: "pick",
        rank: "04",
        name: "Seatylock Mason Antivol en U Certifié Sold Secure Diamond",
        price: "69,98 €",
        badge: "Sold Secure Diamond",
        tone: "good",
        verdict: "Classé Sold Secure Diamond, le plus haut niveau de cette certification, avec des barres transversales brevetées.",
        pros: ["Certifié Sold Secure Diamond, niveau maximal", "Barres transversales triangulaires brevetées"],
        cons: ["Format compact de 14 cm, moins polyvalent pour attacher le cadre"],
        href: "https://www.amazon.fr/dp/B0D3RGPXWN?tag=secure012de-21",
        image: "/images/products/seatylock-mason-antivol-u-diamond.jpg",
        imageAlt: "Seatylock Mason Antivol en U Certifié Sold Secure Diamond",
      },
      {
        k: "pick",
        rank: "05",
        name: "ABUS Granit XPlus 540 Antivol en U avec Support",
        price: "99,99 €",
        badge: "Cylindre XPlus",
        tone: "good",
        verdict: "La référence allemande : cylindre XPlus anti-manipulation, niveau de sécurité 15 chez ABUS et grand arceau de 300 mm.",
        pros: ["Cylindre XPlus conçu contre le crochetage et la manipulation", "Grand arceau de 300 mm, livré avec son support"],
        cons: ["Le plus cher et le plus lourd du comparatif"],
        href: "https://www.amazon.fr/dp/B00H3T773O?tag=secure012de-21",
        image: "/images/products/abus-granit-xplus-540-antivol-u.jpg",
        imageAlt: "ABUS Granit XPlus 540 Antivol en U avec Support",
      },
      { k: "h2", text: "Comment on choisit" },
      { k: "method", items: METHOD_ITEMS },
    ],
  ...
  {
    slug: "films-securite-anti-effraction-fenetre",
    category: "perimeter",
    kind: "comparison",
    kicker: "Comparatif",
    title: "Les 5 meilleurs films de sécurité anti-effraction pour fenêtre",
    excerpt:
      "Une vitre brisée reste le point d'entrée le plus rapide pour un cambrioleur : voici 5 films de sécurité transparents qui retiennent les éclats et ralentissent l'intrusion, du film anti-éclats au film certifié P2A.",
    standfirst:
      "Du film anti-éclats à 15 € au film 350 microns certifié P2A, cinq films transparents à coller sur vos vitres pour renforcer le vitrage sans changer vos fenêtres.",
    meta: "5 produits comparés",
    date: "16 sept.",
    number: 422,
    readingTime: "6 min de lecture",
    updated: "Mis à jour le 16 septembre 2026",
    image: "/images/products/solar-systems-film-anti-effraction-p2a.jpg",
    imageAlt: "Film de sécurité transparent appliqué sur une vitre",
    facts: [
      { value: "5", label: "films comparés" },
      { value: "15 € — 121 €", label: "fourchette de prix" },
      { value: "1", label: "certifié classe P2A" },
    ],
    blocks: [
      {
        k: "p",
        text: "Un film de sécurité se colle côté intérieur de la vitre et maintient le verre en place quand il casse. Il ne rend pas une fenêtre incassable, mais il transforme un coup rapide en un long travail bruyant, et évite les éclats dangereux en cas d'accident. Attention à l'épaisseur : un film de 100 microns (4 mil) protège surtout contre les éclats, tandis qu'un film épais classé P2A est testé pour résister à des impacts répétés. Mesurez vos vitres avant de choisir le format du rouleau.",
      },
      { k: "h2", text: "Notre sélection" },
      {
        k: "pick",
        rank: "01",
        name: "DARUITE Film de Sécurité Anti-Éclats Transparent",
        price: "15,34 €",
        badge: "Premier prix",
        tone: "ok",
        verdict: "Un film PET transparent de 4 mil qui retient les éclats de verre, idéal pour tester sur une petite vitre.",
        pros: ["Le moins cher du comparatif", "Film PET de 4 mil qui maintient les éclats de verre ensemble"],
        cons: ["Épaisseur anti-éclats : ne remplace pas un film anti-effraction certifié"],
        href: "https://www.amazon.fr/dp/B0F8NTS3V7?tag=secure012de-21",
        image: "/images/products/daruite-film-securite-anti-eclats.jpg",
        imageAlt: "DARUITE Film de Sécurité Anti-Éclats Transparent",
      },
      {
        k: "pick",
        rank: "02",
        name: "DIMEXACT Film Anti-Effraction Incolore 120 Microns",
        price: "18,99 €",
        badge: "Vendeur français",
        tone: "ok",
        verdict: "Un film incolore de 120 microns vendu au mètre, expédié depuis la France, pour les chocs venant de l'extérieur.",
        pros: ["Expédié depuis la France, plusieurs longueurs disponibles", "Film incolore de 120 microns contre les chocs venant de l'extérieur"],
        cons: ["Petite surface pour le prix sur ce format de 75 cm x 1 m"],
        href: "https://www.amazon.fr/dp/B088RL1919?tag=secure012de-21",
        image: "/images/products/dimexact-film-anti-effraction-120-microns.jpg",
        imageAlt: "DIMEXACT Film Anti-Effraction Incolore 120 Microns",
      },
      {
        k: "pick",
        rank: "03",
        name: "AWKAQUN Grand Rouleau Film de Sécurité Transparent Anti-Éclats",
        price: "37,99 €",
        badge: "Grand rouleau",
        tone: "good",
        verdict: "Un rouleau de 5 mètres pour traiter plusieurs fenêtres d'un coup, avec une protection anti-UV en prime.",
        pros: ["Un rouleau pour plusieurs fenêtres", "Rouleau de 76 cm x 5 m qui filtre aussi les UV"],
        cons: ["Film anti-éclats, pas de certification anti-effraction"],
        href: "https://www.amazon.fr/dp/B07S6QP9KS?tag=secure012de-21",
        image: "/images/products/awkaqun-film-securite-transparent-5m.jpg",
        imageAlt: "AWKAQUN Grand Rouleau Film de Sécurité Transparent Anti-Éclats",
      },
      {
        k: "pick",
        rank: "04",
        name: "Solar Systems Film Anti-Effraction 350 Microns Classe P2A",
        price: "74,90 €",
        badge: "Classe P2A",
        tone: "good",
        verdict: "Le seul film certifié du comparatif : 350 microns d'épaisseur et une classe de sécurité P2A contre les tentatives d'intrusion.",
        pros: ["Seul film certifié P2A du comparatif", "Épaisseur de 350 microns, bien au-delà des films anti-éclats"],
        cons: ["Film épais plus délicat à poser proprement sur une grande vitre"],
        href: "https://www.amazon.fr/dp/B0G3PCL63R?tag=secure012de-21",
        image: "/images/products/solar-systems-film-anti-effraction-p2a.jpg",
        imageAlt: "Solar Systems Film Anti-Effraction 350 Microns Classe P2A",
      },
      {
        k: "pick",
        rank: "05",
        name: "BDF S4MC Rouleau XXL Film de Sécurité Transparent",
        price: "121,03 €",
        badge: "Rouleau XXL",
        tone: "good",
        verdict: "Un rouleau de près de 15 mètres pour équiper toute la maison, avec un blocage de 99 % des UV.",
        pros: ["De quoi équiper toute la maison", "Rouleau de 61 cm x 14,9 m qui bloque 99 % des UV"],
        cons: ["Le plus cher, et seulement 4 mil d'épaisseur"],
        href: "https://www.amazon.fr/dp/B00PR2JMA0?tag=secure012de-21",
        image: "/images/products/bdf-s4mc-film-securite-rouleau.jpg",
        imageAlt: "BDF S4MC Rouleau XXL Film de Sécurité Transparent",
      },
      { k: "h2", text: "Comment on choisit" },
      { k: "method", items: METHOD_ITEMS },
    ],
  ...
  {
    slug: "extincteurs-couvertures-anti-feu-maison",
    category: "response",
    kind: "comparison",
    kicker: "Comparatif",
    title: "Les 5 meilleurs extincteurs et couvertures anti-feu pour la maison",
    excerpt:
      "Un début d'incendie se maîtrise dans les premières secondes, ou pas du tout : voici 5 équipements anti-feu pour la maison, de la couverture pour la cuisine au lot de deux extincteurs 6 kg.",
    standfirst:
      "De la couverture anti-feu à 12 € au lot de deux extincteurs 6 kg, cinq équipements pour éteindre un départ de feu avant l'arrivée des pompiers.",
    meta: "5 produits comparés",
    date: "16 sept.",
    number: 423,
    readingTime: "6 min de lecture",
    updated: "Mis à jour le 16 septembre 2026",
    image: "/images/products/smartwares-extincteur-poudre-6kg.jpg",
    imageAlt: "Extincteur fixé au mur d'une maison",
    facts: [
      { value: "5", label: "équipements comparés" },
      { value: "12 € — 90 €", label: "fourchette de prix" },
      { value: "3", label: "extincteurs à poudre ABC" },
    ],
    blocks: [
      {
        k: "p",
        text: "Le détecteur de fumée vous prévient, mais il n'éteint rien. Pour un feu de poêle, une couverture anti-feu posée sur la casserole suffit souvent. Pour un départ de feu plus large, un extincteur à poudre ABC couvre les feux de matériaux solides, de liquides et de gaz. L'essentiel est de l'avoir à portée de main, près de la cuisine ou du garage, et de savoir s'en servir. En cas de doute ou de feu qui progresse, sortez et appelez le 18 ou le 112.",
      },
      { k: "h2", text: "Notre sélection" },
      {
        k: "pick",
        rank: "01",
        name: "FLASLD Couverture Anti-Feu Grand Format en Fibre de Verre",
        price: "12,00 €",
        badge: "Premier prix",
        tone: "ok",
        verdict: "Le réflexe pour la cuisine : on tire, on pose sur la poêle en feu, et l'oxygène est coupé.",
        pros: ["Idéale contre les feux de poêle", "Le moins cher du comparatif, format 120 x 120 cm"],
        cons: ["Adaptée aux petits feux localisés, pas à un départ d'incendie étendu"],
        href: "https://www.amazon.fr/dp/B09RX1ZJHJ?tag=secure012de-21",
        image: "/images/products/flasld-couverture-anti-feu-120cm.jpg",
        imageAlt: "FLASLD Couverture Anti-Feu Grand Format en Fibre de Verre",
      },
      {
        k: "pick",
        rank: "02",
        name: "Smartwares Extincteur en Spray pour Feux de Cuisine",
        price: "19,57 €",
        badge: "Format spray",
        tone: "ok",
        verdict: "Un aérosol compact qui se manipule comme une bombe de peinture, pensé pour les feux de cuisine et de graisse.",
        pros: ["Aussi simple qu'une bombe de peinture", "Aérosol de 750 ml adapté aux feux de graisse"],
        cons: ["Usage unique et capacité limitée"],
        href: "https://www.amazon.fr/dp/B0DMTH57J3?tag=secure012de-21",
        image: "/images/products/smartwares-extincteur-spray-750ml.jpg",
        imageAlt: "Smartwares Extincteur en Spray pour Feux de Cuisine",
      },
      {
        k: "pick",
        rank: "03",
        name: "Lifebox Extincteur à Poudre 2 kg avec Manomètre",
        price: "32,90 €",
        badge: "Manomètre",
        tone: "good",
        verdict: "Un extincteur à poudre ABC de 2 kg avec manomètre pour vérifier d'un coup d'œil qu'il est toujours sous pression.",
        pros: ["Manomètre pour vérifier la pression", "Poudre ABC : feux de solides, de liquides et de gaz"],
        cons: ["Capacité de 2 kg, à doubler pour une grande maison"],
        href: "https://www.amazon.fr/dp/B007C1S9FS?tag=secure012de-21",
        image: "/images/products/lifebox-extincteur-poudre-2kg.jpg",
        imageAlt: "Lifebox Extincteur à Poudre 2 kg avec Manomètre",
      },
      {
        k: "pick",
        rank: "04",
        name: "Smartwares Grand Extincteur à Poudre 6 kg avec Support Mural",
        price: "54,99 €",
        badge: "Meilleur rapport",
        tone: "good",
        verdict: "La taille de référence pour une maison : 6 kg de poudre ABC et un support mural pour le garder à portée de main.",
        pros: ["Taille de référence pour une maison", "6 kg de poudre ABC et support mural inclus"],
        cons: ["Plus lourd à manier qu'un modèle de 2 kg"],
        href: "https://www.amazon.fr/dp/B0DW429QVS?tag=secure012de-21",
        image: "/images/products/smartwares-extincteur-poudre-6kg.jpg",
        imageAlt: "Smartwares Grand Extincteur à Poudre 6 kg avec Support Mural",
      },
      {
        k: "pick",
        rank: "05",
        name: "Gloria Lot de 2 Extincteurs à Poudre 6 kg avec Supports Muraux",
        price: "89,99 €",
        badge: "Lot de 2",
        tone: "good",
        verdict: "Deux extincteurs à poudre ABC de 6 kg avec supports muraux, pour protéger deux étages ou la maison et le garage.",
        pros: ["Lot de deux extincteurs 6 kg pour couvrir deux zones", "Supports muraux fournis"],
        cons: ["Le plus cher du comparatif"],
        href: "https://www.amazon.fr/dp/B09VCH72HP?tag=secure012de-21",
        image: "/images/products/gloria-pde6-lot-2-extincteurs-6kg.jpg",
        imageAlt: "Gloria Lot de 2 Extincteurs à Poudre 6 kg avec Supports Muraux",
      },
      { k: "h2", text: "Comment on choisit" },
      { k: "method", items: METHOD_ITEMS },
    ],
  ...
  {
    slug: "motorisations-portail-battant",
    category: "perimeter",
    kind: "comparison",
    kicker: "Comparatif",
    title: "Les 5 meilleures motorisations pour portail battant",
    excerpt:
      "Un portail motorisé se referme tout seul derrière vous au lieu de rester ouvert : voici 5 kits de motorisation pour portail battant, du modèle à télécommande au moteur connecté piloté depuis le téléphone.",
    standfirst:
      "Du kit Avidsen à 200 € à la motorisation connectée Somfy à bras, cinq moteurs pour ouvrir et refermer le portail sans sortir de la voiture.",
    meta: "5 produits comparés",
    date: "16 sept.",
    number: 424,
    readingTime: "6 min de lecture",
    updated: "Mis à jour le 16 septembre 2026",
    image: "/images/products/somfy-evolvia-star-connecte-portail.jpg",
    imageAlt: "Motorisation installée sur un portail battant",
    facts: [
      { value: "5", label: "motorisations comparées" },
      { value: "200 € — 899 €", label: "fourchette de prix" },
      { value: "3", label: "pilotables depuis le téléphone" },
    ],
    blocks: [
      {
        k: "p",
        text: "Un portail laissé ouvert, c'est une invitation. La motorisation règle le problème : fermeture automatique, ouverture sans descendre de voiture la nuit, et pour les modèles connectés, la possibilité de vérifier et de commander le portail depuis le téléphone. Avant de choisir, mesurez la largeur et le poids de chaque battant, l'espace disponible sur les piliers, et vérifiez le sens d'ouverture : vérins, bras articulés ou moteurs à vis ne s'installent pas dans les mêmes conditions.",
      },
      { k: "h2", text: "Notre sélection" },
      {
        k: "pick",
        rank: "01",
        name: "Avidsen Styrka 310 Motorisation pour Portail Battant",
        price: "199,90 €",
        badge: "Premier prix",
        tone: "ok",
        verdict: "Le kit le plus abordable pour un portail à deux battants jusqu'à 5 m et 300 kg, avec mode piéton.",
        pros: ["Mode piéton et deux télécommandes incluses", "Le moins cher du comparatif, pour un portail jusqu'à 5 m et 300 kg"],
        cons: ["Pas de pilotage depuis le téléphone"],
        href: "https://www.amazon.fr/dp/B0BFHLFV56?tag=secure012de-21",
        image: "/images/products/avidsen-styrka-310-motorisation-portail.jpg",
        imageAlt: "Avidsen Styrka 310 Motorisation pour Portail Battant",
      },
      {
        k: "pick",
        rank: "02",
        name: "Avidsen Teha Connect Motorisation à Vérins pour Portail Battant",
        price: "249,90 €",
        badge: "Connectée",
        tone: "good",
        verdict: "Le portail connecté au meilleur prix : pilotage au smartphone, commande vocale et détection d'obstacle.",
        pros: ["Se pilote au téléphone ou vocalement", "Sécurité en cas d'obstacle pendant la fermeture"],
        cons: ["Limitée aux battants de 1,75 m et 150 kg"],
        href: "https://www.amazon.fr/dp/B0BFHV5XS7?tag=secure012de-21",
        image: "/images/products/avidsen-teha-connect-motorisation-verins.jpg",
        imageAlt: "Avidsen Teha Connect Motorisation à Vérins pour Portail Battant",
      },
      {
        k: "pick",
        rank: "03",
        name: "SCS Sentinel Motorisation à Bras Articulés pour Portail Lourd",
        price: "374,90 €",
        badge: "Portails lourds",
        tone: "good",
        verdict: "Des bras articulés qui acceptent les portails larges et lourds, jusqu'à 5 m et 500 kg, avec 5 ans de garantie.",
        pros: ["Pour les portails larges et lourds", "Jusqu'à 5 m et 500 kg, garantie 5 ans et feu clignotant LED"],
        cons: ["Pas de pilotage depuis le téléphone d'origine"],
        href: "https://www.amazon.fr/dp/B0BX3PSL7J?tag=secure012de-21",
        image: "/images/products/scs-sentinel-mba0103-motorisation-bras.jpg",
        imageAlt: "SCS Sentinel Motorisation à Bras Articulés pour Portail Lourd",
      },
      {
        k: "pick",
        rank: "04",
        name: "Somfy Exavia Star Connecté Motorisation à Vérins",
        price: "573,90 €",
        badge: "Kit complet",
        tone: "good",
        verdict: "Le kit Somfy complet : kit de connectivité, batterie de secours et cellules photoélectriques, compatible Alexa et Google Home.",
        pros: ["Batterie de secours et cellules photoélectriques incluses", "Compatible Alexa et Google Home, pilotable à distance"],
        cons: ["Battants limités à 2,50 m de large et 2 m de haut"],
        href: "https://www.amazon.fr/dp/B09NKZ1L5V?tag=secure012de-21",
        image: "/images/products/somfy-exavia-star-connecte-portail.jpg",
        imageAlt: "Somfy Exavia Star Connecté Motorisation à Vérins",
      },
      {
        k: "pick",
        rank: "05",
        name: "Somfy Evolvia Star Connecté Motorisation à Bras",
        price: "899,00 €",
        badge: "Ouverture en 8 s",
        tone: "good",
        verdict: "Le haut de gamme Somfy : ouverture à 90° en 8 secondes, compatible TaHoma, Alexa et Google Home.",
        pros: ["Ouverture complète en seulement 8 secondes", "Compatible TaHoma, Alexa et Google Home"],
        cons: ["Le plus cher du comparatif"],
        href: "https://www.amazon.fr/dp/B0D47MLLQK?tag=secure012de-21",
        image: "/images/products/somfy-evolvia-star-connecte-portail.jpg",
        imageAlt: "Somfy Evolvia Star Connecté Motorisation à Bras",
      },
      { k: "h2", text: "Comment on choisit" },
      { k: "method", items: METHOD_ITEMS },
    ],
