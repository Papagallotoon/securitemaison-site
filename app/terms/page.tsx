...
export default function TermsPage() {
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 text-sm leading-relaxed text-brand-800">
      ...
      <p className="mt-2">
        {SITE.siteName} est un outil d'auto-évaluation gratuit. Il fournit un
        résultat informatif personnalisé basé sur vos réponses, ainsi que des
        recommandations de produits. Ce n'est ni un conseil médical, juridique
        ou financier, et son utilisation ne crée aucune relation professionnelle.
      </p>

      <h2 className="mt-8 text-lg font-semibold text-brand-950">Aucune garantie</h2>
      <p className="mt-2">
        Les résultats et recommandations sont uniquement informatifs. Nous ne
        garantissons aucun résultat lié à leur suivi ou à l'achat d'un produit
        recommandé.
      </p>
